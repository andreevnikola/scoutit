...
export class ProfileService {
  ...
  updateProfile(description: string, address: string, city: string, country: string, workTypes: { freelance: boolean; halfDay: boolean; fullDay: boolean }, workPlace: { home: boolean; office: boolean }) {
